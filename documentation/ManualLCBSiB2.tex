...
\item Obtenha o programa ``calibraSiB2\_leastsq.py'' de \textbf{srcLCB}/calibracaoSiB2/radiation.
...
\item Observe que a saída deve ser ter a seguinte forma:
...
\subsection{Determinação da dos parâmetros aerodinâmicos a serem calibrados conforme a variação do índice de área foliar no tempo com uso da derive\_trans}
\label{zlt_aero_ts}
...
\item Obtenha o programa ``calibraSiB2\_momentum\_leastsq.py'' de \textbf{srcLCB}/calibracaoSiB2/momentum.
...
\item Copie o arquivo ``zlt\_aero\_ts.dat'' gerado em \ref{zlt_aero_ts}para o mesmo diretório do sib2pymod, ``data1'', ``data2'', ``data3.csv'' e ``calibraSiB2\_momentum\_leastsq.py''  
...
\item A saída deve ser ter a seguinte forma:
...
\begin{enumerate}
\item Obtenha o código do módulo de umidade do solo em \textbf{srcsib2model}/SiB2pymod/Soil-MoistureModule. 
\item  Compile e gere o módulo de Python
\begin{Verbatim}[breaklines=true]
f2py3.7 --fcompiler=gnu95 -c *.f95 -m sib2pymod
\end{Verbatim}
...
\item Obtenha o programa ``calibraSiB2\_leastsq.py'' de \textbf{srcLCB}/calibracaoSiB2/umidade.
...
\begin{enumerate}
\item Obtenha o código do módulo de carbono e água em \textbf{srcsib2model}/SiB2pymod/Carbon-WaterModule. 
\item  Compile e gere o módulo de Python
\begin{Verbatim}[breaklines=true]
f2py3.7 --fcompiler=gnu95 -c *.f95 -m sib2pymod
\end{Verbatim}

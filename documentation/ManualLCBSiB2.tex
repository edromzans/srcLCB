...
Esta documentação faz referência aos repositórios: \textbf{hidromodel}, \textbf{srcLCB} e \textbf{srcsib2model}. O repositório \textbf{hidromodel} possui o modelo de balanço hidrológico para pequenas bacias hidrográficas proposto em \citeonline{vandewiele1992}, \textbf{srcLCB} é composto de códigos utilitários para o LCB/IAG/USP, enquanto o \textbf{srcsib2model} concentra apenas o código fonte do modelo SiB2 \cite{sellers1996I,sellers1996II}.

Os repositórios \textbf{hidromodel}, \textbf{srcLCB} e \textbf{srcsib2model} estão versionados pelo sistema Git, portanto é possível avaliar todo o respectivo histórico de desenvolvimento de cada código usando os comandos do git.  

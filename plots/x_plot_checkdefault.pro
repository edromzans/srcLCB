...
;for k = 15L, 17L do begin
  ...
  plot, SiBvar, SiBvardefault, title = titlevar, xtitle = xtag, ytitle = ytag, $
  ...
  plot, datetime, SiBvar - SiBvardefault, ytitle = 'desvio', xstyle = 1, ystyle = 1, $
        ...
        xtickinterval =  365.5 * fxtimeinterval
  ...
  plot, SiBvar_dayavg, SiBvardefault_dayavg, title = titlevar, xtitle = xtag, ytitle = ytag, $
        xstyle = 1, ystyle = 1,  psym = 3
  ...
  plot, SiBvar_monthavg, SiBvardefault_monthavg, title = titlevar, xtitle = xtag, ytitle = ytag, $
        xstyle = 1, ystyle = 1,  psym = 3

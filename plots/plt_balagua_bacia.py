...
plt.plot(xx, yy, c='green', linewidth=0.8)
plt.scatter(P_ano_plt_to_ET_P, ET_ano_plt, c='red', marker='1',
            linewidth=0.8, label='ET')
plt.scatter(P_ano_plt_to_QcP, Qc_ano_plt, c='blue', marker='.',
            linewidth=0.8, label='Q$_c$')
plt.scatter(P_ano_plt_to_QmP, Qm_ano_plt, c='black', marker='+',
